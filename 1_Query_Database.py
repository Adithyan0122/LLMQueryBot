...
Only return the SQL query, nothing else. Make string comparisons case-insensitive by using LOWER(column_name) and LOWER('value') where applicable. Ensure the result returns only unique student records using SELECT DISTINCT.
"""
